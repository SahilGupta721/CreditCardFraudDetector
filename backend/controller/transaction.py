"""
The motive of this code to generate predicted values for some already existed data in MongoDB, so once we got the predicted values that
output gonna be used for our frontend dashboard
